...
ALTER TABLE STAGE_NAME DROP CONSTRAINT FK_STAGE_NAME_PROJECT_STAGE_ID_Stage_Name;
...
CREATE TABLE PROJECT(
	...
	ID_Engineer int UNIQUE NOT NULL,
...
CREATE TABLE PROJECT_STAGE(
	...
	ID_Stage_Name int UNIQUE NOT NULL,
